...
const Portfolio = () => {
    ...
    return ( 
        <div className="Portfolio pt-[140px] pb-[280px] xl:pb-[443px]">
            ...
            <div className="flex flex-row w-[70%] xl:w-[60%] items-center justify-center mx-auto xl:items-center xl:justify-center mb-[100px]">
                ...
                <h1 className='text-center text-primary self-center text-[16px] sm:text-[26px] xl:text-[25px] mx-[60px]'>Web Dev Projects</h1>
