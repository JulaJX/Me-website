...
const About = () => {
    return ( 
        <div className="About" id="about">
            ...
            <div className="flex flex-col items-center justify-center xl:items-center md:justify-center  h-[500px] mb-[150px] md:mb-[210px] sm:mb-[300px]">
                ...
                <div className="flex flex-col xl:flex-row item-center justify-center text-primary w-[80%] xl:w-[60%]  mt-[40px] xl:mt-[70px] tracking-wider leading-10">
                    ...
                    <Link to="/portfolio" className='text-[13px] sm:text-[14px] md:text-[15px] xl:text-[18px] text-primary'>
