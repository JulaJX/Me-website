...
const About = () => {
    return ( 
        <div className="About" id="about">
            ...
            <div className="bg-mbg flex lg:pt-[290px]  pt-[120px] flex-col items-center justify-center xl:items-center md:justify-center h-[600px] sm:h-[500px] pb-[350px] md:pb-[410px]  sm:pb-[300px] z-[10]">
